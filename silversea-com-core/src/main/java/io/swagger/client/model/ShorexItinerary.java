...
public class ShorexItinerary {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(shorexItineraryId, shorexId, shorexUrl, shorexCod, shorexName, cityId, cityUrl, voyageId, voyageUrl, date, plannedDepartureTime, generalDepartureTime, duration);
  }
