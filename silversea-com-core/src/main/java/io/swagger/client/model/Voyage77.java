...
public class Voyage77 {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(isDeleted, isVisible, loadVoyage, mapId, mapSvgUrl, images, voyageHighlights, voyageId, voyageUrl, voyageCod, voyageName, voyageMarketName, voyageDescription, departDate, arriveDate, isExpedition, itineraryUrl, days, destinationId, destinationUrl, shipId, shipUrl, mapUrl, features);
  }
