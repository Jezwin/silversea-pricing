...
public class GatewayApi {
    ...
    private com.squareup.okhttp.Call gatewayGetValidateBeforeCall(Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Gateway>> gatewayGetWithHttpInfo(Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = gatewayGetValidateBeforeCall(page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call gatewayGetAsync(Integer page, Integer perPage, String envelope, final ApiCallback<List<Gateway>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = gatewayGetValidateBeforeCall(page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Gateway>>(){}.getType();
