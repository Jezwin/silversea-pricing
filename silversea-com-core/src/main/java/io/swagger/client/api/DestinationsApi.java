...
public class DestinationsApi {
    ...
    private com.squareup.okhttp.Call destinationsGetValidateBeforeCall(String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Destination>> destinationsGetWithHttpInfo(String envelope) throws ApiException {
        com.squareup.okhttp.Call call = destinationsGetValidateBeforeCall(envelope, null, null);
    ...
    public com.squareup.okhttp.Call destinationsGetAsync(String envelope, final ApiCallback<List<Destination>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = destinationsGetValidateBeforeCall(envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Destination>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call destinationsGetOneValidateBeforeCall(Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Destination> destinationsGetOneWithHttpInfo(Integer id) throws ApiException {
        com.squareup.okhttp.Call call = destinationsGetOneValidateBeforeCall(id, null, null);
    ...
    public com.squareup.okhttp.Call destinationsGetOneAsync(Integer id, final ApiCallback<Destination> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = destinationsGetOneValidateBeforeCall(id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Destination>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
