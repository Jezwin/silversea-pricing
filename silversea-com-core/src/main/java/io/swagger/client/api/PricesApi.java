...
public class PricesApi {
    ...
    private com.squareup.okhttp.Call pricesGetValidateBeforeCall(String currencyCod, Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<VoyagePrice>> pricesGetWithHttpInfo(String currencyCod, Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = pricesGetValidateBeforeCall(currencyCod, page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call pricesGetAsync(String currencyCod, Integer page, Integer perPage, String envelope, final ApiCallback<List<VoyagePrice>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = pricesGetValidateBeforeCall(currencyCod, page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<VoyagePrice>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call pricesGet2ValidateBeforeCall(Integer voyageId, String currencyCod, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<VoyagePrice> pricesGet2WithHttpInfo(Integer voyageId, String currencyCod, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = pricesGet2ValidateBeforeCall(voyageId, currencyCod, envelope, null, null);
    ...
    public com.squareup.okhttp.Call pricesGet2Async(Integer voyageId, String currencyCod, String envelope, final ApiCallback<VoyagePrice> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = pricesGet2ValidateBeforeCall(voyageId, currencyCod, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VoyagePrice>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call pricesGet3ValidateBeforeCall(Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<VoyagePriceComplete>> pricesGet3WithHttpInfo(Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = pricesGet3ValidateBeforeCall(page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call pricesGet3Async(Integer page, Integer perPage, String envelope, final ApiCallback<List<VoyagePriceComplete>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = pricesGet3ValidateBeforeCall(page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<VoyagePriceComplete>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
