...
public class BrochuresApi {
    ...
    private com.squareup.okhttp.Call brochuresGetValidateBeforeCall(String countryIso3, Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Brochure>> brochuresGetWithHttpInfo(String countryIso3, Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = brochuresGetValidateBeforeCall(countryIso3, page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call brochuresGetAsync(String countryIso3, Integer page, Integer perPage, String envelope, final ApiCallback<List<Brochure>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = brochuresGetValidateBeforeCall(countryIso3, page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Brochure>>(){}.getType();
