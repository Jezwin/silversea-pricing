...
public class LandsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<LandItinerary> landsGetItineraryChanges(String changesFrom, Integer page, Integer perPage, String envelope) throws ApiException {
        ApiResponse<List<LandItinerary>> resp = landsGetItineraryChangesWithHttpInfo(changesFrom, page, perPage, envelope);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<LandItinerary>> landsGetItineraryChangesWithHttpInfo(String changesFrom, Integer page, Integer perPage, String envelope) throws ApiException {
