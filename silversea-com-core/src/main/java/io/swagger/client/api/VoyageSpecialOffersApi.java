...
public class VoyageSpecialOffersApi {
    ...
    private com.squareup.okhttp.Call voyageSpecialOffersGetValidateBeforeCall(String countryIso3, Integer voyageId, Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<VoyageSpecialOffer>> voyageSpecialOffersGetWithHttpInfo(String countryIso3, Integer voyageId, Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = voyageSpecialOffersGetValidateBeforeCall(countryIso3, voyageId, page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call voyageSpecialOffersGetAsync(String countryIso3, Integer voyageId, Integer page, Integer perPage, String envelope, final ApiCallback<List<VoyageSpecialOffer>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = voyageSpecialOffersGetValidateBeforeCall(countryIso3, voyageId, page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<VoyageSpecialOffer>>(){}.getType();
