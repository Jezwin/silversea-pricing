...
public class ShipSuitesApi {
    ...
    private com.squareup.okhttp.Call shipSuitesGetValidateBeforeCall(Integer shipId, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<ShipSuite>> shipSuitesGetWithHttpInfo(Integer shipId, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = shipSuitesGetValidateBeforeCall(shipId, envelope, null, null);
    ...
    public com.squareup.okhttp.Call shipSuitesGetAsync(Integer shipId, String envelope, final ApiCallback<List<ShipSuite>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = shipSuitesGetValidateBeforeCall(shipId, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<ShipSuite>>(){}.getType();
