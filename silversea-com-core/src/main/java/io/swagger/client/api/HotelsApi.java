...
public class HotelsApi {
    ...
    private com.squareup.okhttp.Call hotelsGetValidateBeforeCall(Integer cityId, Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Hotel>> hotelsGetWithHttpInfo(Integer cityId, Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = hotelsGetValidateBeforeCall(cityId, page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call hotelsGetAsync(Integer cityId, Integer page, Integer perPage, String envelope, final ApiCallback<List<Hotel>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = hotelsGetValidateBeforeCall(cityId, page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Hotel>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call hotelsGetChangesValidateBeforeCall(String changesFrom, Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Hotel77>> hotelsGetChangesWithHttpInfo(String changesFrom, Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = hotelsGetChangesValidateBeforeCall(changesFrom, page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call hotelsGetChangesAsync(String changesFrom, Integer page, Integer perPage, String envelope, final ApiCallback<List<Hotel77>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = hotelsGetChangesValidateBeforeCall(changesFrom, page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Hotel77>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call hotelsGetItineraryValidateBeforeCall(Integer cityId, Integer voyageId, DateTime date, Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<HotelItinerary>> hotelsGetItineraryWithHttpInfo(Integer cityId, Integer voyageId, DateTime date, Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = hotelsGetItineraryValidateBeforeCall(cityId, voyageId, date, page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call hotelsGetItineraryAsync(Integer cityId, Integer voyageId, DateTime date, Integer page, Integer perPage, String envelope, final ApiCallback<List<HotelItinerary>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = hotelsGetItineraryValidateBeforeCall(cityId, voyageId, date, page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<HotelItinerary>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call hotelsGetItinerary2ValidateBeforeCall(String changesFrom, Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<HotelItinerary77>> hotelsGetItinerary2WithHttpInfo(String changesFrom, Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = hotelsGetItinerary2ValidateBeforeCall(changesFrom, page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call hotelsGetItinerary2Async(String changesFrom, Integer page, Integer perPage, String envelope, final ApiCallback<List<HotelItinerary77>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = hotelsGetItinerary2ValidateBeforeCall(changesFrom, page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<HotelItinerary77>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call hotelsGetOneValidateBeforeCall(Integer id, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Hotel>> hotelsGetOneWithHttpInfo(Integer id, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = hotelsGetOneValidateBeforeCall(id, envelope, null, null);
        Type localVarReturnType = new TypeToken<List<Hotel>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call hotelsGetOneAsync(Integer id, String envelope, final ApiCallback<List<Hotel>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = hotelsGetOneValidateBeforeCall(id, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Hotel>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
