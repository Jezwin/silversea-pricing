...
public class SpecialOffersApi {
    ...
    private com.squareup.okhttp.Call specialOffersGetValidateBeforeCall(Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<SpecialOffer>> specialOffersGetWithHttpInfo(Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = specialOffersGetValidateBeforeCall(page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call specialOffersGetAsync(Integer page, Integer perPage, String envelope, final ApiCallback<List<SpecialOffer>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = specialOffersGetValidateBeforeCall(page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<SpecialOffer>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call specialOffersGetOneValidateBeforeCall(Integer id, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<SpecialOffer> specialOffersGetOneWithHttpInfo(Integer id, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = specialOffersGetOneValidateBeforeCall(id, envelope, null, null);
    ...
    public com.squareup.okhttp.Call specialOffersGetOneAsync(Integer id, String envelope, final ApiCallback<SpecialOffer> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = specialOffersGetOneValidateBeforeCall(id, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<SpecialOffer>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
