...
public class FeaturesApi {
    ...
    private com.squareup.okhttp.Call featuresGetValidateBeforeCall(String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Feature>> featuresGetWithHttpInfo(String envelope) throws ApiException {
        com.squareup.okhttp.Call call = featuresGetValidateBeforeCall(envelope, null, null);
    ...
    public com.squareup.okhttp.Call featuresGetAsync(String envelope, final ApiCallback<List<Feature>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = featuresGetValidateBeforeCall(envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Feature>>(){}.getType();
