...
public class ItinerariesApi {
    ...
    private com.squareup.okhttp.Call itinerariesGetValidateBeforeCall(String after, String before, Integer destinationId, Integer shipId, Integer page, Integer perPage, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Itinerary>> itinerariesGetWithHttpInfo(String after, String before, Integer destinationId, Integer shipId, Integer page, Integer perPage, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = itinerariesGetValidateBeforeCall(after, before, destinationId, shipId, page, perPage, envelope, null, null);
    ...
    public com.squareup.okhttp.Call itinerariesGetAsync(String after, String before, Integer destinationId, Integer shipId, Integer page, Integer perPage, String envelope, final ApiCallback<List<Itinerary>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = itinerariesGetValidateBeforeCall(after, before, destinationId, shipId, page, perPage, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Itinerary>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call itinerariesGetByIdValidateBeforeCall(Integer id, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Itinerary>> itinerariesGetByIdWithHttpInfo(Integer id, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = itinerariesGetByIdValidateBeforeCall(id, envelope, null, null);
        Type localVarReturnType = new TypeToken<List<Itinerary>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call itinerariesGetByIdAsync(Integer id, String envelope, final ApiCallback<List<Itinerary>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = itinerariesGetByIdValidateBeforeCall(id, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Itinerary>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
