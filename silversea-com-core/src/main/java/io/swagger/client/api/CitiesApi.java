...
public class CitiesApi {
    ...
    private com.squareup.okhttp.Call citiesGetValidateBeforeCall(String city, String countryIso3, Integer page, Integer perPage, String languageCod, String envelope, String embed, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<City>> citiesGetWithHttpInfo(String city, String countryIso3, Integer page, Integer perPage, String languageCod, String envelope, String embed) throws ApiException {
        com.squareup.okhttp.Call call = citiesGetValidateBeforeCall(city, countryIso3, page, perPage, languageCod, envelope, embed, null, null);
    ...
    public com.squareup.okhttp.Call citiesGetAsync(String city, String countryIso3, Integer page, Integer perPage, String languageCod, String envelope, String embed, final ApiCallback<List<City>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = citiesGetValidateBeforeCall(city, countryIso3, page, perPage, languageCod, envelope, embed, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<City>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call citiesGetChangesValidateBeforeCall(String changesFrom, Integer page, Integer perPage, String languageCod, String envelope, String embed, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<City77>> citiesGetChangesWithHttpInfo(String changesFrom, Integer page, Integer perPage, String languageCod, String envelope, String embed) throws ApiException {
        com.squareup.okhttp.Call call = citiesGetChangesValidateBeforeCall(changesFrom, page, perPage, languageCod, envelope, embed, null, null);
    ...
    public com.squareup.okhttp.Call citiesGetChangesAsync(String changesFrom, Integer page, Integer perPage, String languageCod, String envelope, String embed, final ApiCallback<List<City77>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = citiesGetChangesValidateBeforeCall(changesFrom, page, perPage, languageCod, envelope, embed, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<City77>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call citiesGetOneValidateBeforeCall(Integer id, String languageCod, String envelope, String embed, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<City> citiesGetOneWithHttpInfo(Integer id, String languageCod, String envelope, String embed) throws ApiException {
        com.squareup.okhttp.Call call = citiesGetOneValidateBeforeCall(id, languageCod, envelope, embed, null, null);
    ...
    public com.squareup.okhttp.Call citiesGetOneAsync(Integer id, String languageCod, String envelope, String embed, final ApiCallback<City> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = citiesGetOneValidateBeforeCall(id, languageCod, envelope, embed, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<City>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
