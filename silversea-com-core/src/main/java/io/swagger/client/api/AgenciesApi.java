...
public class AgenciesApi {
    ...
    private com.squareup.okhttp.Call agenciesGetValidateBeforeCall(String agency, String countryIso3, String stateCod, String zip, String city, Integer page, Integer perPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Agency>> agenciesGetWithHttpInfo(String agency, String countryIso3, String stateCod, String zip, String city, Integer page, Integer perPage) throws ApiException {
        com.squareup.okhttp.Call call = agenciesGetValidateBeforeCall(agency, countryIso3, stateCod, zip, city, page, perPage, null, null);
    ...
    public com.squareup.okhttp.Call agenciesGetAsync(String agency, String countryIso3, String stateCod, String zip, String city, Integer page, Integer perPage, final ApiCallback<List<Agency>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = agenciesGetValidateBeforeCall(agency, countryIso3, stateCod, zip, city, page, perPage, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Agency>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call agenciesGetNearValidateBeforeCall(Double lat, Double lon, Integer r, Integer page, Integer perPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Agency> agenciesGetNearWithHttpInfo(Double lat, Double lon, Integer r, Integer page, Integer perPage) throws ApiException {
        com.squareup.okhttp.Call call = agenciesGetNearValidateBeforeCall(lat, lon, r, page, perPage, null, null);
    ...
    public com.squareup.okhttp.Call agenciesGetNearAsync(Double lat, Double lon, Integer r, Integer page, Integer perPage, final ApiCallback<Agency> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = agenciesGetNearValidateBeforeCall(lat, lon, r, page, perPage, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Agency>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call agenciesGetOneValidateBeforeCall(Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Agency> agenciesGetOneWithHttpInfo(Integer id) throws ApiException {
        com.squareup.okhttp.Call call = agenciesGetOneValidateBeforeCall(id, null, null);
        Type localVarReturnType = new TypeToken<Agency>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call agenciesGetOneAsync(Integer id, final ApiCallback<Agency> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = agenciesGetOneValidateBeforeCall(id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Agency>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
