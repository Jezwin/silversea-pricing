...
public class SuitesApi {
    ...
    private com.squareup.okhttp.Call suitesGetValidateBeforeCall(String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<SuiteCategory>> suitesGetWithHttpInfo(String envelope) throws ApiException {
        com.squareup.okhttp.Call call = suitesGetValidateBeforeCall(envelope, null, null);
    ...
    public com.squareup.okhttp.Call suitesGetAsync(String envelope, final ApiCallback<List<SuiteCategory>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = suitesGetValidateBeforeCall(envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<SuiteCategory>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call suitesGetCategoriesValidateBeforeCall(String voyageCod, String currencyCod, Integer numberGuests, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<CategoryAvailability> suitesGetCategoriesWithHttpInfo(String voyageCod, String currencyCod, Integer numberGuests, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = suitesGetCategoriesValidateBeforeCall(voyageCod, currencyCod, numberGuests, envelope, null, null);
    ...
    public com.squareup.okhttp.Call suitesGetCategoriesAsync(String voyageCod, String currencyCod, Integer numberGuests, String envelope, final ApiCallback<CategoryAvailability> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = suitesGetCategoriesValidateBeforeCall(voyageCod, currencyCod, numberGuests, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CategoryAvailability>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call suitesGetSuiteAvailableValidateBeforeCall(String voyageCod, String suiteCategoryCod, String currencyCod, Integer numberGuests, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<SuiteAvailability> suitesGetSuiteAvailableWithHttpInfo(String voyageCod, String suiteCategoryCod, String currencyCod, Integer numberGuests, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = suitesGetSuiteAvailableValidateBeforeCall(voyageCod, suiteCategoryCod, currencyCod, numberGuests, envelope, null, null);
    ...
    public com.squareup.okhttp.Call suitesGetSuiteAvailableAsync(String voyageCod, String suiteCategoryCod, String currencyCod, Integer numberGuests, String envelope, final ApiCallback<SuiteAvailability> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = suitesGetSuiteAvailableValidateBeforeCall(voyageCod, suiteCategoryCod, currencyCod, numberGuests, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<SuiteAvailability>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
