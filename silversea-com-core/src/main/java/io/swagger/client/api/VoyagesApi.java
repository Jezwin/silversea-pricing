...
public class VoyagesApi {
    ...
    private com.squareup.okhttp.Call voyagesGetValidateBeforeCall(Integer destinationId, Integer shipId, Integer voyageId, String after, String before, Integer page, Integer perPage, String languageCod, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Voyage>> voyagesGetWithHttpInfo(Integer destinationId, Integer shipId, Integer voyageId, String after, String before, Integer page, Integer perPage, String languageCod, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = voyagesGetValidateBeforeCall(destinationId, shipId, voyageId, after, before, page, perPage, languageCod, envelope, null, null);
    ...
    public com.squareup.okhttp.Call voyagesGetAsync(Integer destinationId, Integer shipId, Integer voyageId, String after, String before, Integer page, Integer perPage, String languageCod, String envelope, final ApiCallback<List<Voyage>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = voyagesGetValidateBeforeCall(destinationId, shipId, voyageId, after, before, page, perPage, languageCod, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Voyage>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call voyagesGet2ValidateBeforeCall(Integer year, Integer month, Integer destinationId, Integer shipId, Integer page, Integer perPage, String languageCod, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Voyage>> voyagesGet2WithHttpInfo(Integer year, Integer month, Integer destinationId, Integer shipId, Integer page, Integer perPage, String languageCod, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = voyagesGet2ValidateBeforeCall(year, month, destinationId, shipId, page, perPage, languageCod, envelope, null, null);
        Type localVarReturnType = new TypeToken<List<Voyage>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call voyagesGet2Async(Integer year, Integer month, Integer destinationId, Integer shipId, Integer page, Integer perPage, String languageCod, String envelope, final ApiCallback<List<Voyage>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = voyagesGet2ValidateBeforeCall(year, month, destinationId, shipId, page, perPage, languageCod, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Voyage>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call voyagesGet3ValidateBeforeCall(Integer id, String languageCod, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Voyage>> voyagesGet3WithHttpInfo(Integer id, String languageCod, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = voyagesGet3ValidateBeforeCall(id, languageCod, envelope, null, null);
        Type localVarReturnType = new TypeToken<List<Voyage>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call voyagesGet3Async(Integer id, String languageCod, String envelope, final ApiCallback<List<Voyage>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = voyagesGet3ValidateBeforeCall(id, languageCod, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Voyage>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for voyagesGetExcursions */
    private com.squareup.okhttp.Call voyagesGetExcursionsCall(Integer voyageId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/v1/voyages/{voyage_id}/shoreExcursions".replaceAll("\\{format\\}","json")
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call voyagesGetExcursionsValidateBeforeCall(Integer voyageId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'voyageId' is set
        if (voyageId == null) {
            throw new ApiException("Missing the required parameter 'voyageId' when calling voyagesGetExcursions(Async)");
        }
        
        
        com.squareup.okhttp.Call call = voyagesGetExcursionsCall(voyageId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Shorex> voyagesGetExcursions(Integer voyageId) throws ApiException {
        ApiResponse<List<Shorex>> resp = voyagesGetExcursionsWithHttpInfo(voyageId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Shorex>> voyagesGetExcursionsWithHttpInfo(Integer voyageId) throws ApiException {
        com.squareup.okhttp.Call call = voyagesGetExcursionsValidateBeforeCall(voyageId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call voyagesGetExcursionsAsync(Integer voyageId, final ApiCallback<List<Shorex>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = voyagesGetExcursionsValidateBeforeCall(voyageId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Shorex>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call voyagesGetItineraryValidateBeforeCall(Integer voyageId, String languageCod, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Itinerary>> voyagesGetItineraryWithHttpInfo(Integer voyageId, String languageCod, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = voyagesGetItineraryValidateBeforeCall(voyageId, languageCod, envelope, null, null);
    ...
    public com.squareup.okhttp.Call voyagesGetItineraryAsync(Integer voyageId, String languageCod, String envelope, final ApiCallback<List<Itinerary>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = voyagesGetItineraryValidateBeforeCall(voyageId, languageCod, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Itinerary>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
