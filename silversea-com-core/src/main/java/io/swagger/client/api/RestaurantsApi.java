...
public class RestaurantsApi {
    ...
    private com.squareup.okhttp.Call restaurantsGetValidateBeforeCall(Integer shipId, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Restaurant>> restaurantsGetWithHttpInfo(Integer shipId, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = restaurantsGetValidateBeforeCall(shipId, envelope, null, null);
    ...
    public com.squareup.okhttp.Call restaurantsGetAsync(Integer shipId, String envelope, final ApiCallback<List<Restaurant>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = restaurantsGetValidateBeforeCall(shipId, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Restaurant>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call restaurantsGetOneValidateBeforeCall(Integer id, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Restaurant>> restaurantsGetOneWithHttpInfo(Integer id, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = restaurantsGetOneValidateBeforeCall(id, envelope, null, null);
        Type localVarReturnType = new TypeToken<List<Restaurant>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call restaurantsGetOneAsync(Integer id, String envelope, final ApiCallback<List<Restaurant>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = restaurantsGetOneValidateBeforeCall(id, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Restaurant>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
