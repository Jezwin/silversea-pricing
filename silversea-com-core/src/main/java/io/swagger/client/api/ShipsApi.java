...
public class ShipsApi {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call shipsGetOneValidateBeforeCall(String id, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
