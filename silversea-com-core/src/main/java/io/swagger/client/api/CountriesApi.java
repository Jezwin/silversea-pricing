...
public class CountriesApi {
    ...
    private com.squareup.okhttp.Call countriesGetValidateBeforeCall(String countryIso3, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<List<Country>> countriesGetWithHttpInfo(String countryIso3, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = countriesGetValidateBeforeCall(countryIso3, envelope, null, null);
    ...
    public com.squareup.okhttp.Call countriesGetAsync(String countryIso3, String envelope, final ApiCallback<List<Country>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = countriesGetValidateBeforeCall(countryIso3, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Country>>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call countriesGetOneValidateBeforeCall(Integer id, String envelope, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Country> countriesGetOneWithHttpInfo(Integer id, String envelope) throws ApiException {
        com.squareup.okhttp.Call call = countriesGetOneValidateBeforeCall(id, envelope, null, null);
    ...
    public com.squareup.okhttp.Call countriesGetOneAsync(Integer id, String envelope, final ApiCallback<Country> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = countriesGetOneValidateBeforeCall(id, envelope, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Country>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
