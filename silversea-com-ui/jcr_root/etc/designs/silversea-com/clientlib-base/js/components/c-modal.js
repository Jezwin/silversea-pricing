        ...
        if (!$('body').hasClass("viewport-xs")) { //check if not mobile
        	...
        	if (window.hasOwnProperty("cruiseItem") && window.cruiseItem != null) {
        		...
        		if (virtualTourImage != null) {
        			var virtualTourToRender = '<div id="c-suite-detail-modal-virtual-tour-containerDiv" class="c-suite-detail-modal-virtual-tour-container" data-image="'+virtualTourImage+'"></div>';
