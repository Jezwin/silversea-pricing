...
<div <%= attrs.build() %>><%
    ...
    <ol class="coral-Multifields-list coral-Multifield-list js-coral-Multifield-list"><%
        for (int i = 0; i < values.length; i++) {
            Map<String, String> retMap = new Gson().fromJson(values[i].toString(), new TypeToken<HashMap<String, Object>>() {}.getType());%>
            <li class="coral-Multifields-input coral-Multifield-input js-coral-Multifield-input">
                <section class="multifields-wrapper coral-Form-fieldset" data-name="<%=name %>"><%
                ...
                while(it.hasNext()){
                   ...
                   if(!childNode.getPath().startsWith("/etc/scaffolding/") || childNode.isResourceType("granite/ui/components/foundation/form/pathbrowser")) {
                       %>
