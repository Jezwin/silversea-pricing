(function ($, $document) {
    ...
    function addDataInFields() {
        ...
        function dlgReadyHandler() {
            var outerMultifields = getMultifields($("form.foundation-form"), false),
                $form = $("form.foundation-form"),
    ...
    function collectDataFromFields(){
        ...
        $document.on("click", "#shell-propertiespage-saveactivator", collectHandler);
    	
        function collectHandler() {	
        	var eamDataNested = $("[" + DATA_EAEM_NESTED + "]").data("eaemNested");
        	if (eamDataNested != NODE_STORE) {
        		return;
        	}
